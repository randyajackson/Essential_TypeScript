...
function calculateTax2(amount: number, format: boolean): string | number | null 
{
    if (amount === 0) {
        return null;
    }
...
let testNull: string | number | null = calculateTax2(0, true);
...
let taxValue: string | number = calculateTax2(100, false)!;
